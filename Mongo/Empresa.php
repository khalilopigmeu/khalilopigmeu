...
<fieldset  v-if="optCad==='fisica'" class="border rounded container-fluid border-dark">
    ...
    <input type="date" v-model="DataNasc" name="DataNasc" class="data datepicker form-control"><br>
</fieldset>
<fieldset v-else-if="optCad==='juridica'" class="border rounded container-fluid border-dark">
    ...
    <input type="text" v-model="NomeFantasia" name="NomeFantasia" class="form-control"><br>
