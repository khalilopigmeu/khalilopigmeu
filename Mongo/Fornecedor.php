...
<fieldset  v-if="optCad==='fisica'" class="border rounded container-fluid border-dark">
    ...
    <input type="text" class="cpf form-control" placeholder="xxx.xxx.xxx-xx" v-model="Cpf" name="Cpf"><br>
    ...
    <input type="text" v-model="DataNasc" name="DataNasc" class="data form-control"><br>
</fieldset>
<fieldset v-else-if="optCad==='juridica'" class="border rounded container-fluid border-dark">
    ...
    <input type="text" placeholder="xx.xxx.xxx/xxxx-xx" class="cnpj form-control" v-model="Cnpj" name="Cnpj"><br>
...
<input type="text" data-vue="<?php echo $page; ?>" v-model="CEP" name="CEP" placeholder="xxxxx-xxx" class="cep form-control"><br>
