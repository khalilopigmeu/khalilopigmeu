                ...
                <div class="row justify-content-center">
                    <form action="" method="post">
                        <fieldset class="border rounded container-fluid border-dark my-3 py-3 w-90">
                            ...
                            <input type="text" data-vue="clientLogin" v-model="CEP" name="CEP" placeholder="xxxxx-xxx" class="cep form-control"><br>
                            ...
                            <input type="email" placeholder="email@email.com"  class="form-control" v-model="Email" name="Email" required="required"><br>
