<div id="empresasanunciando" v-if="app.sys.page==='anunciante'||app.sys.page==='videos'" class="border rounded glory m-3 p-3 shadow-lg borda-x text-center justify-content-center">
    ...
    <div v-if="app.sys.page==='anunciante'">
        ...
        <div v-else>
            ...
            <div v-if="tipo==='4'" id="toOpen" v-bind:data-url="getSite(pgid)">
                {{cast()}}
            </div>
            <div v-if="tipo==='5'" id="toOpen" v-bind:data-url="'https://wa.me/55'+cleanwap(Empresa(pgid).Celular)">
                {{cast()}}
            </div>
            <div v-if="tipo==='6'" id="toOpen" v-bind:data-url="'https://facebook.com/'+getFB(pgid)">
                {{cast()}}
            </div>
            <div v-if="tipo==='7'"  id="toOpen" v-bind:data-url="'https://instagram.com/'+getInsta(pgid)">
                {{cast()}}
            </div>
        </div>
    </div>
    <div class="container-fluid" v-if="app.sys.page==='videos'">
        <div class="row">
            <div class="col-3 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                <img v-bind:src="getLogo(Empresa(pgid)._id['$oid'])" class="img-thumbnail rounded mx-auto d-block">   
            </div>
            <div class="col-9 col-sm-12 col-md-12 col-lg-9 col-xl-9">
        ...
        <div class="row">
            <div class="col-md-12 col-12 justify-content-center">
                <div v-for="itens in paginas">
                    <h2 class="spanCli text-center m-2 p-2" v-if="itens.UrlPage===getParameterByName('pgtime')">{{itens.Titulo}}</h2>
                    <div class="text-left" v-if="itens.UrlPage===getParameterByName('pgtime')" v-html="itens.ContentPage"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-4 col-xl-4 col-12" v-if="Empresa(pgid).Celular!='null'"><span class='spanCli m-2 p-2'><i class="fab fa-whatsapp"></i> whatsapp:</span> <a class='listA' target="_blank" v-bind:href="'https://wa.me/55'+cleanwap(Empresa(pgid).Celular)">{{Empresa(pgid).Celular}}</a></div>
            <div class="col-md-12 col-lg-4 col-xl-4 col-12" v-if="getFB(Empresa(pgid)._id['$oid'])!=null"><span class='spanCli m-2 p-2'><i class="fab fa-facebook-f"></i> Facebook:</span> <a class='listA' target="_blank" v-bind:href="'https://facebook.com/'+getFB(Empresa(pgid)._id['$oid'])">@{{getFB(Empresa(pgid)._id['$oid'])}}</a></div>
            <div class="col-md-12 col-lg-4 col-xl-4 col-12" v-if="getInsta(Empresa(pgid)._id['$oid'])!=null"><span class='spanCli m-2 p-2'><i class="fab fa-instagram"></i> Instagram:</span> <a class='listA' target="_blank" v-bind:href="'https://instagram.com/'+getInsta(Empresa(pgid)._id['$oid'])">@{{getInsta(Empresa(pgid)._id['$oid'])}}</a></div>
            <div class="col-md-12 col-lg-4 col-xl-4 col-12" v-if="getSite(Empresa(pgid)._id['$oid'])!=null"><span class='spanCli m-2 p-2'><i class="fas fa-globe"></i> Site:</span> <a class='listA' target="_blank" v-bind:href="getSite(Empresa(pgid)._id['$oid'])">
                    <span v-if="Empresa(pgid).NomeFantasia">
                        {{Empresa(pgid).NomeFantasia}}
                    </span>
                    <span class="spanCli" v-else>
